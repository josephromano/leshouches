...
\cite{TheLIGOScientific:2016-GW150914,TheLIGOScientific:2017-GW170817,TheLIGOScientifi:2018-GWTC-1}.
But despite the fact that one cannot resolve individual 
signals, the detection of a gravitational-wave 
...
~\cite{Penzias-Wilson:1965, Dicke-et-al:1965}.
...
because the time-delay interferometry (TDI) data
combinations that one uses to remove the laser
frequency noise are orthogonal to one another.
...
background due LISA motion around the Sun 
(Figure~\ref{f:cyclostationarity}).
