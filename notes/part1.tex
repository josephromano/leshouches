...
signals that comprise the background, the detection of a 
...
\begin{figure}[htbp!]
\begin{center}
\includegraphics[width=0.7\textwidth]{CMB}
...
\begin{figure}[htbp!]
\begin{center}
\includegraphics[width=0.65\textwidth]{BBH-BNS-timeseries}
...
\begin{figure}[htbp!]
\begin{center}
\includegraphics[width=0.65\textwidth]{BBH-BNS-SNR}
\caption{Expected signal-to-noise ratio as a function of
observation time for the standard cross-correlation search 
using the advanced LIGO and Virgo detectors.
...
\begin{figure}[htbp!]
\begin{center}
\includegraphics[width=\textwidth]{GWspectrum}
...
\begin{figure}[htbp!]
\begin{center}
\includegraphics[width=\textwidth]{statiso-vs-aniso}
...
\begin{figure}[htbp!]
\begin{center}
\includegraphics[width=0.6\textwidth]{cyclostationary_data}
...
individual BNS merger and BBH ringdown%
...
\begin{figure}[htbp!]
\begin{center}
\includegraphics[width=\textwidth]{different_power_spectra}
...
\begin{figure}[htbp!]
\begin{center}
\includegraphics[width=0.4\textwidth]{polarizations}
...
\begin{figure}[htbp!]
\begin{center}
\includegraphics[width=0.4\textwidth]{plane_wave}
...
spectrum is given by the coefficients $C_l$ of a Legendre 
...
\begin{figure}[htbp!]
\begin{center}
\includegraphics[width=0.45\textwidth]{binary_inspiral}
...
is {\em uncorrelated} (which is typically a valid assumption 
...
\ee
%
where $Q(t,t')$ is an a~priori arbitrary filter 
...
\delta_T(f,f')\tilde d_1(f)\tilde d^*_2(f') \tilde Q^*(f')\,,
\ee
%
...
\begin{figure}[htbp!]
\begin{center}
\includegraphics[width=\textwidth]{simple_examples}
