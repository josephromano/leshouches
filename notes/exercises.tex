...
\abstract{We provide some suggested exercises accompanying the 
lectures on searches for stochastic gravitational-wave backgrounds.}
...
stellar-mass binary black hole mergers by multiplying LIGO's 
O1 local rate 
estimate $R_0 \sim 10$~-~$200~{\rm Gpc}^{-3}\,{\rm yr}^{-1}$ by 
the comoving volume out to some large redshift, e.g., 
$z\simeq 10$.
(You can ignore any dependence of the rate density with 
redshift.)
You should find a rate of $\sim 1$~per minute to a few per hour.
...
\i {\em Optimal filtering for cross-correlation statistic:}
\addcontentsline{toc}{subsection}
{4 Optimal filtering for cross-correlation statistic}
...
%
which
has all of the properties of the familiar inner product
...
$M\equiv M_{i\alpha}$ is response matrix mapping 
...
\i {\em Timing-residual response for 1-arm, 1-way detector:}
\addcontentsline{toc}{subsection}
{6 Timing-residual response for 1-arm, 1-way detector}
...
\i {\em Maximum-likelihood estimators for standard 
cross-correlation statistic:}
\addcontentsline{toc}{subsection}
{8 Maximum-likelihood estimators for standard 
cross-correlation statistic}
...
\i {\em Derivation of maximum-likelihood ratio detection statistic:}
\addcontentsline{toc}{subsection}
{9 Derivation of maximum-likelihood ratio detection statistic}
