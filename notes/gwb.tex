...
\caption{Simiulated time-domain output of a particular 
...
This is atypical, however, 
as most expected GWBs (e.g., for advanced LIGO, Virgo, 
pulsar timing arrays, and CMB polarization measurements) 
will be buried well below the instrumental noise,
requiring observation over long periods of time to 
confidently detect.

(iii) Stochastic backgrounds can their power spectra
...
\caption{Simulated sky maps of gravitational-wave power
for both a statistically isotropic (left panel) and an 
anisotropic (right panel) background.}
