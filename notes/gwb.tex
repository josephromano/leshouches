...
\subsection{Different sources across the GW spectrum}
...
rise, in general, to different properties of the signal.
This will allow us to infer the source of the 
background from the observed properties of the signal.
For example:

(i) Stochastic backgrounds can differ in spatial 
distribution---i.e., the angular distribution of 
