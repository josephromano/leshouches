...
distribution for those parameters (Figure~\ref{f:informative_data}).
For this case, the marginalized likelihoods have the 
approximate form 
%
\be
p(d|{\cal M}_\alpha) \equiv
...
\end{figure}
%
Substituting the above expression for the marginalized
likelihood functions into \eqref{e:bayes_factor} yields
%
\be
{\cal B}_{10}(d) 
