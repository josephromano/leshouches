...
If there is no {\em a~priori} reason prefer one model over 
...
For this case the signal prior is Dirac delta function that
...
treats all segments on equal footing, looking for 
