...
(The overlap function for two identical, coincident
and coaligned detectors---i.e., an auto-correlation
measurement---is just the identity.)
...
$R_I(f,\hat k)$ for different detectors, we now
...
Plots of thee overlap functions, on a log-scale frequency
axis are given in Figure~{f:orfs}.
