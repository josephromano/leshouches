...
for $\xi$ for the first 16 segments (so first 4~sec) of data.
...
the BBH background using the standard cross-correlation 
method is reduced to $\sim\!1$~day using the Bayesian method
described here.
